...
$OutputJar = Join-Path $BuildDir 'PZItemPickInfoContainerFix-agent.jar'
...
& $Java -Xverify:all -cp "$GameJar;$AsmJar;$ClassesDir;$TestClassesDir" `
    cn.zombiecommunity.pzitempickfix.TransformSmokeTest $GameJar
...
& $Java -Xverify:all -cp "$GameJar;$ClassesDir;$TestClassesDir" `
    cn.zombiecommunity.pzitempickfix.RuntimeIntegrationTest
...
& $Java -Xverify:all "-javaagent:$OutputJar" `
    ...
    cn.zombiecommunity.pzitempickfix.GameClassLoadSmokeTest
