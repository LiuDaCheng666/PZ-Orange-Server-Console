...
$OutputJar = Join-Path $BuildDir 'PZSpriteConfigAliasPatch-agent.jar'
...
& $Java -Xverify:all -cp "$GameJar;$AsmJar;$ClassesDir;$TestClassesDir" `
    cn.zombiecommunity.pzspritealias.TransformSmokeTest $GameJar
...
& $Java -Xverify:all "-javaagent:$OutputJar=enabled=true" `
    -cp "$GameJar;$OutputJar;$TestClassesDir" `
    cn.zombiecommunity.pzspritealias.AgentIntegrationTest
