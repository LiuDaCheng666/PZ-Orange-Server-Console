...
$OutputJar = Join-Path $BuildDir 'PZEntityRegistrationGuard-agent.jar'
...
& $Java -Xverify:all -cp "$GameJar;$AsmJar;$ClassesDir;$TestClassesDir" `
    cn.zombiecommunity.pzentityguard.TransformSmokeTest $GameJar
...
& $Java -Xverify:all "-javaagent:$OutputJar" -cp "$GameJar;$OutputJar;$TestClassesDir" `
    cn.zombiecommunity.pzentityguard.EntityRegistrationIntegrationTest
